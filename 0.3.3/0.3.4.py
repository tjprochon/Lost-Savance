...
L1S1 = pygame.image.load("Assets/Level/l1s1.png")
#L1S2 = pygame.image.load("Assets/Level/l1s2.png")
#L1S3 = pygame.image.load("Assets/Level/l1s3.png")
...
def displayL0S1():
    ...
    #mob1 1
    if mob1HP > 0:
        gameDisplay.blit(mob1, (mob1X, (mob1Y - 7)))
    #mob2 1
    if mob2HP > 0:
        gameDisplay.blit(mob2, (mob2X, (mob2Y - 9)))
